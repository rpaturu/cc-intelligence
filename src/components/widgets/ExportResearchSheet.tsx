...
export function ExportResearchSheet({
  isOpen,
  onOpenChange,
  currentCompany,
  userName,
      ...
      <SheetContent side="right" className="w-[96vw] xs:w-[92vw] sm:w-[85vw] md:w-[80vw] lg:w-[900px] max-w-[96vw] sm:max-w-[900px] flex flex-col h-screen overflow-hidden">
        <SheetHeader className="flex-shrink-0 px-6 pt-6">
          <SheetTitle className="flex items-center gap-2">
            ...
            Research Report - {currentCompany}
          </SheetTitle>
          <SheetDescription>
            Complete research summary generated by {userName} on {new Date().toLocaleDateString()}
          </SheetDescription>
        </SheetHeader>
